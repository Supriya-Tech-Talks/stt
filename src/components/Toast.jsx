...
export default function Toast({ message, type = 'info', onClose }) {
  ...
  return (
    <motion.div
      ...
      className={`pointer-events-auto flex items-center gap-3 rounded-lg border px-4 py-3 shadow-lg ${styles[type]}`}
      role="alert"
    >
      ...
      <button
        type="button"
        onClick={onClose}
        className="ml-auto flex-shrink-0 rounded p-1 hover:bg-black/10 dark:hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-inset"
